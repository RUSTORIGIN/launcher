...
|---|---|---|
| Rounded 32px card, 1px stroke, shadow | `WindowChrome` + `mainGrid.Clip` + `edgeBorder` | ✅ rendered - rounded frameless window with native behaviour (drag/resize/maximize/snap); flat when maximized |
